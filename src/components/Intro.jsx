...
function Intro() {
  return (
    <div className="flex items-center justify-center flex-col text-center pt-20 pb-6 rounded-lg shadow-lg">
      ...
      <p className="text-base max-w-lg mb-6 font-normal text-gray-800 dark:text-gray-200 leading-relaxed">
